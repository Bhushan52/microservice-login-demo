...
import com.appdeveloperblog.phtoapp.api.users.ui.model.LoginRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	@Autowired
	public AuthenticationFilter( Environment environment,AuthenticationManager authenticationManager, UserService userService) {
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		...
		.signWith(SignatureAlgorithm.HS512, environment.getProperty("secret.token"))
		.compact();
